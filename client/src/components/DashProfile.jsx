...
const dispatch = useDispatch();
    ...
    //Based on this APP when we request the firebase to upload the image he will understand 
    // that it's the same person who will upload it
     const storage = getStorage(app);
     //When we upload an image we will have his file name so to be unique we add a date for it 
     const fileName = new Date().getTime() + imageFile.name;
     //We will store it after that 
     const storageRef = ref(storage,fileName)
     //And we will upload the task
        ...
        const handleSubmit = async (e) => {
          ...
          try {
            ...
            if(!res.ok) {
              ...
              setUpadateUserSuccess("User Profile updated successfully");
            }
    ...
    const handleDeleteUser = async () => {
      ...
      try {
        ...
        //And now we will create our response
  ...
  return (
    <div className="max-w-lg mx-auto p-3 w-full">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        {/* filepicker ref is to click directly in the profile image and hidd the input */}
